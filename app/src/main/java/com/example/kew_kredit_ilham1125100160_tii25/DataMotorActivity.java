...
public class DataMotorActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Mengizinkan operasi jaringan di main thread (hanya untuk debugging/emulator lama)
    ...
    //Refresh Data: Me-restart activity untuk memuat ulang data
    ...
    public void tampildataMotor() {
        ...
        try {
            ...
            // Mengiterasi dan menampilkan data
            for (int i = 0; i < arrayMotor.length(); i++) {
                ...
                // Memberi warna latar belakang bergantian
                if (i % 2 == 0) {
    ...
    public void getMotorByKdmotor(int idmotor) {
        ...
        //layout Input.addView(editKdMotor);
        ...
        //membuat edit text di Aliert builder
        ...
        //builderEdi Biodata.setIcon(R.drawable.batagrams);
        ...
        builderEditMotor.setPositiveButton("Update", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                // tambahkan restart activity di sini.
            }
        });
